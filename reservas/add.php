        ...
        if (isset($_POST['confirm']) && $_POST['confirm'] == 1) {
            ...
            if (!$fecha) {
                ...
                if ($res) {
                    ...
                    $res = $reservas->addReserva2($fecha, $esp, $id_paciente, $_SESSION['usuario_id'], $hor, $nombreProfecional);
                ...
                <div class="mb-3">
                    ...
                    <select name="nomEmpl" class="form-control">
                        ...
                        <?php foreach($nombreEmpleado as $nomEmpl): ?>
                            ...
                            <option value="<?php echo $nomEmpl['nombre']; ?>"><?php echo $nomEmpl['nombre']; ?></option>
